		...
		<section className="py-20 px-4">
			<div className="max-w-6xl mx-auto">
				...
				<div className="grid grid-cols-1 gap-8">
					{[
						{
							title: 'Automated Data Pipeline for Loan Approval Predictions',
							description: 'Built a machine learning pipeline for predicting loan approval based on customer financial data.',
							details: [
								'Preprocessed structured data with Pandas & Scikit-learn',
								'Trained and evaluated logistic regression and random forest models',
								'Automated pipeline using Python and scheduled via cron',
								'Deployed results via Streamlit for interactive exploration',
							],
