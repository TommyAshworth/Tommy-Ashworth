			...
			<div className="relative z-10 max-w-4xl w-full mx-4">
				...
				>
					...
					<div className="font-mono">
						...
						<h1 className="text-4xl md:text-5xl font-bold mt-2 mb-4">Tommy Ashworth</h1>
						...
						<div className="flex flex-wrap gap-2 mt-2">
							...
							<span className="px-3 py-1 bg-green-500/10 rounded-md border border-green-500/20">NumPy</span>
							...
							<span className="px-3 py-1 bg-green-500/10 rounded-md border border-green-500/20">Matplotlib</span>
							<span className="px-3 py-1 bg-green-500/10 rounded-md border border-green-500/20">Seaborn</span>
							<span className="px-3 py-1 bg-green-500/10 rounded-md border border-green-500/20">Plotly</span>
						</div>
					</div>
				</motion.div>
			</div>
